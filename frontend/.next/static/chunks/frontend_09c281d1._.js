...
const INFURA_API_KEY = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_INFURA_API_KEY || 'b18fb7e6ca7045ac83c41157ab93f990';
    ...
    chains: [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$chains$2f$definitions$2f$hardhat$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hardhat"],
        {
            ...
            rpcUrls: {
                default: {
                    http: [
                        "https://sepolia.infura.io/v3/".concat(INFURA_API_KEY)
                    ]
                }
            }
        }
...
function ErrorFilter() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ErrorFilter.useEffect": ()=>{
            ...
            const filterError = {
                "ErrorFilter.useEffect.filterError": function() {
            ...
            }["ErrorFilter.useEffect.filterError"];
            // Filter function for warnings
            const filterWarn = {
                "ErrorFilter.useEffect.filterWarn": function() {
                    for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                        args[_key] = arguments[_key];
                    }
                    var _args_;
            ...
            }["ErrorFilter.useEffect.filterWarn"];
            // Filter console.log for network errors
            const filterLog = {
                "ErrorFilter.useEffect.filterLog": function() {
                    for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                        args[_key] = arguments[_key];
                    }
                    var _args_;
            ...
            }["ErrorFilter.useEffect.filterLog"];
        ...
        "ErrorFilter.useEffect": ()=>{
            const handleError = {
                "ErrorFilter.useEffect.handleError": (event)=>{
                    ...
                    const target = ((_this = event.target) === null || _this === void 0 ? void 0 : _this.src) || ((_this1 = event.target) === null || _this1 === void 0 ? void 0 : _this1.href) || "";
            ...
            const handleRejection = {
                "ErrorFilter.useEffect.handleRejection": (event)=>{
            ...
            }["ErrorFilter.useEffect.handleRejection"];
...
_s(ErrorFilter, "3ubReDTFssvu4DHeldAg55cW/CI=");
_c = ErrorFilter;
var _c;
