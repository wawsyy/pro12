...
function useEthersSigner() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useEthersSigner.useEffect": ()=>{
            ...
            let cancelled = false;
            walletClientToSigner(walletClient).then({
                "useEthersSigner.useEffect": (s)=>{
                    if (!cancelled) {
                        setSigner(s);
                    }
                }
            }["useEthersSigner.useEffect"]).catch({
                "useEthersSigner.useEffect": (error)=>{
...
"[project]/frontend/abi/GlucoseCheckAddresses.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
*/ __turbopack_context__.s([
    "GlucoseCheckAddresses",
    ()=>GlucoseCheckAddresses
]);
const GlucoseCheckAddresses = {
    "11155111": {
...
"[project]/frontend/abi/GlucoseCheckABI.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/frontend/hooks/useGlucoseCheck.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$GlucoseCheckAddresses$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/abi/GlucoseCheckAddresses.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$GlucoseCheckABI$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/abi/GlucoseCheckABI.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
;
...
;
;
function getGlucoseCheckByChainId(chainId) {
    if (!chainId) {
        return {
            abi: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$GlucoseCheckABI$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GlucoseCheckABI"].abi
        };
    }
    const entry = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$GlucoseCheckAddresses$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GlucoseCheckAddresses"][chainId.toString()];
    if (!entry || !("address" in entry) || entry.address === __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroAddress) {
        return {
            abi: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$GlucoseCheckABI$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GlucoseCheckABI"].abi,
            chainId
        };
...
const useGlucoseCheck = (parameters)=>{
    _s();
    ...
    const [glucoseHandle, setGlucoseHandle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    const [riskResultHandle, setRiskResultHandle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    const [clearRiskResult, setClearRiskResult] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    const clearRiskResultRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    ...
    const [isChecking, setIsChecking] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const glucoseCheckRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    const isSubmittingRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(isSubmitting);
    const isCheckingRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(isChecking);
    ...
    const isDecrypted = riskResultHandle && riskResultHandle === (clearRiskResult === null || clearRiskResult === void 0 ? void 0 : clearRiskResult.handle);
    const glucoseCheck = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useGlucoseCheck.useMemo[glucoseCheck]": ()=>{
            const c = getGlucoseCheckByChainId(chainId);
            glucoseCheckRef.current = c;
            if (!c.address) {
                setMessage("GlucoseCheck deployment not found for chainId=".concat(chainId, "."));
            }
            return c;
        }
    }["useGlucoseCheck.useMemo[glucoseCheck]"], [
    ...
    const isDeployed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useGlucoseCheck.useMemo[isDeployed]": ()=>{
            if (!glucoseCheck) {
                return undefined;
            }
            return Boolean(glucoseCheck.address) && glucoseCheck.address !== __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroAddress;
        }
    }["useGlucoseCheck.useMemo[isDeployed]"], [
        glucoseCheck
    ]);
    const canSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useGlucoseCheck.useMemo[canSubmit]": ()=>{
            const hasAddress = Boolean(glucoseCheck.address) && glucoseCheck.address !== __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroAddress;
    ...
    const canCheckRisk = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useGlucoseCheck.useMemo[canCheckRisk]": ()=>{
            return glucoseCheck.address && ethersSigner && ethersSigner.address && !isChecking && glucoseHandle && glucoseHandle !== __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroHash;
        }
    }["useGlucoseCheck.useMemo[canCheckRisk]"], [
    ...
    const canDecrypt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useGlucoseCheck.useMemo[canDecrypt]": ()=>{
            return glucoseCheck.address && instance && ethersSigner && ethersSigner.address && !isDecrypting && riskResultHandle && riskResultHandle !== __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroHash && riskResultHandle !== (clearRiskResult === null || clearRiskResult === void 0 ? void 0 : clearRiskResult.handle);
        }
    }["useGlucoseCheck.useMemo[canDecrypt]"], [
        glucoseCheck.address,
        instance,
    ...
    const submitGlucose = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGlucoseCheck.useCallback[submitGlucose]": async (value)=>{
            ...
            const thisGlucoseCheckContract = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(thisGlucoseCheckAddress, glucoseCheck.abi, thisEthersSigner);
            isSubmittingRef.current = true;
            setIsSubmitting(true);
            setMessage("Encrypting glucose value ".concat(value, "..."));
            const run = {
                "useGlucoseCheck.useCallback[submitGlucose].run": async ()=>{
                    await new Promise({
                        "useGlucoseCheck.useCallback[submitGlucose].run": (resolve)=>setTimeout(resolve, 100)
                    }["useGlucoseCheck.useCallback[submitGlucose].run"]);
                    const isStale = {
                        "useGlucoseCheck.useCallback[submitGlucose].run.isStale": ()=>{
                            var _glucoseCheckRef_current;
                            const addressChanged = thisGlucoseCheckAddress !== ((_glucoseCheckRef_current = glucoseCheckRef.current) === null || _glucoseCheckRef_current === void 0 ? void 0 : _glucoseCheckRef_current.address);
                    ...
                    try {
                        ...
                        const input = instance.createEncryptedInput(thisGlucoseCheckAddress, thisEthersSigner.address);
                        input.add32(value);
                        ...
                        while(retries > 0){
                            try {
                                ...
                                // Enhanced error handling
                                // Enhanced error handling
                                tx = await thisGlucoseCheckContract.submitGlucose(enc.handles[0], enc.inputProof);
                                ...
                                if (errorMessage.includes("Relayer didn't response") || errorMessage.includes("backend connection task has stopped") || errorMessage.includes("Transaction rejected")) {
                                    retries--;
                                    if (retries > 0) {
                                        setMessage("Relayer connection issue, retrying... (".concat(retries, " attempts left)"));
                                        // Wait before retry (exponential backoff)
                                        await new Promise({
                                            "useGlucoseCheck.useCallback[submitGlucose].run": (resolve)=>setTimeout(resolve, 2000 * (4 - retries))
                                        }["useGlucoseCheck.useCallback[submitGlucose].run"]);
                                        continue;
                                    } else {
                        ...
                        setMessage("Wait for tx:".concat(tx.hash, "..."));
                        const receipt = await tx.wait();
                        setMessage("Glucose value submitted! status=".concat(receipt === null || receipt === void 0 ? void 0 : receipt.status));
                        if (isStale()) {
                        ...
                        setMessage("Submit failed: ".concat(error.message));
                    } finally{
    ...
    }["useGlucoseCheck.useCallback[submitGlucose]"], [
        ethersSigner,
        glucoseCheck.address,
        glucoseCheck.abi,
        instance,
    ...
    const checkRisk = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGlucoseCheck.useCallback[checkRisk]": async ()=>{
            ...
            const run = {
                "useGlucoseCheck.useCallback[checkRisk].run": async ()=>{
                    const isStale = {
                        "useGlucoseCheck.useCallback[checkRisk].run.isStale": ()=>{
                            var _glucoseCheckRef_current;
                            return thisGlucoseCheckAddress !== ((_glucoseCheckRef_current = glucoseCheckRef.current) === null || _glucoseCheckRef_current === void 0 ? void 0 : _glucoseCheckRef_current.address) || !sameChain.current(thisChainId) || !sameSigner.current(thisEthersSigner);
                        }
                    }["useGlucoseCheck.useCallback[checkRisk].run.isStale"];
                    try {
                        // Enhanced error handling// Change #28 - 174454
                        ...
                        // Enhanced error handling
                        // Enhanced error handling
                        const tx = await thisGlucoseCheckContract.checkRisk();
                        setMessage("Wait for tx:".concat(tx.hash, "..."));
                        const receipt = await tx.wait();
                        setMessage("Risk assessment completed! status=".concat(receipt === null || receipt === void 0 ? void 0 : receipt.status));
                        if (isStale()) {
                        ...
                        setMessage("Check risk failed: ".concat(error.message));
                    } finally{
                        isCheckingRef.current = false;
                        setIsChecking(false);
                    }
                }
            }["useGlucoseCheck.useCallback[checkRisk].run"];
            run();
        }
    }["useGlucoseCheck.useCallback[checkRisk]"], [
        ethersSigner,
        glucoseCheck.address,
        glucoseCheck.abi,
        chainId,
    ...
    const decryptRiskResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGlucoseCheck.useCallback[decryptRiskResult]": ()=>{
            var _clearRiskResultRef_current;
            ...
            if (riskResultHandle === ((_clearRiskResultRef_current = clearRiskResultRef.current) === null || _clearRiskResultRef_current === void 0 ? void 0 : _clearRiskResultRef_current.handle)) {
                return;
            }
            if (!riskResultHandle) {
            ...
            if (riskResultHandle === __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroHash) {
                setClearRiskResult({
                    handle: riskResultHandle,
                    clear: false
                });
            ...
            const run = {
                "useGlucoseCheck.useCallback[decryptRiskResult].run": async ()=>{
                    const isStale = {
                        "useGlucoseCheck.useCallback[decryptRiskResult].run.isStale": ()=>{
                            var _glucoseCheckRef_current;
                            return thisGlucoseCheckAddress !== ((_glucoseCheckRef_current = glucoseCheckRef.current) === null || _glucoseCheckRef_current === void 0 ? void 0 : _glucoseCheckRef_current.address) || !sameChain.current(thisChainId) || !sameSigner.current(thisEthersSigner);
                        }
                    }["useGlucoseCheck.useCallback[decryptRiskResult].run.isStale"];
                    try {
                        ...
                        const res = await instance.userDecrypt([
                            {
                                ...
                                contractAddress: thisGlucoseCheckAddress
                            }
                        ], sig.privateKey, sig.publicKey, sig.signature.replace("0x", ""), sig.contractAddresses, sig.userAddress, sig.startTimestamp.toString(), sig.durationDays.toString());
                        setMessage("FHEVM userDecrypt completed!");
                        if (isStale()) {
                            setMessage("Ignore FHEVM decryption");
                            return;
                        }
                        const decryptedValue = res[thisRiskResultHandle];
                        setClearRiskResult({
                            handle: thisRiskResultHandle,
                        ...
                        setMessage("Risk result: ".concat(decryptedValue ? "High glucose (>140)" : "Normal glucose (�?40)"));
                    } catch (error) {
                        setMessage("Decryption failed: ".concat(error.message));
                    } finally{
                        isDecryptingRef.current = false;
                        setIsDecrypting(false);
                    }
                }
            }["useGlucoseCheck.useCallback[decryptRiskResult].run"];
            run();
        }
    }["useGlucoseCheck.useCallback[decryptRiskResult]"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useGlucoseCheck.useEffect": ()=>{
            ...
            const glucoseCheckContract = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(glucoseCheck.address, glucoseCheck.abi, ethersReadonlyProvider);
            const refresh = {
                "useGlucoseCheck.useEffect.refresh": async ()=>{
                    try {
                        // Enhanced error handling// Change #28 - 174454
                        // Enhanced error handling// Change #20 - 174452
                        // Enhanced error handling// Change #19 - 174452
            ...
            }["useGlucoseCheck.useEffect.refresh"];
            refresh();
            const interval = setInterval(refresh, 5000);
            return ({
                "useGlucoseCheck.useEffect": ()=>clearInterval(interval)
            })["useGlucoseCheck.useEffect"];
        }
    }["useGlucoseCheck.useEffect"], [
        glucoseCheck.address,
    ...
    return {
        ...
        isDecrypted,
        message,
        clearRiskResult: clearRiskResult === null || clearRiskResult === void 0 ? void 0 : clearRiskResult.clear,
        glucoseHandle,
        riskResultHandle,
        isSubmitting,
        isChecking,
...
_s(useGlucoseCheck, "j96qoCRzRTrkyLHzTqYIH9eu+Vg=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function errorNotDeployed(chainId) {
    const chainName = chainId === 11155111 ? "Sepolia" : chainId === 31337 ? "Hardhat" : "Chain ".concat(chainId);
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-black/50 rounded-lg p-4 mt-6 mb-6",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("code", {
                            className: "text-green-400 text-sm block",
                            children: [
                                "# from pro12 directory",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: [
                        ...
                        " (chainId: 31337) using your Rainbow wallet."
                    ]
                }, void 0, true, {
                    fileName: "[project]/frontend/components/ErrorNotDeployed.tsx",
                    lineNumber: 24,
...
"[project]/frontend/components/GlucoseCheckDemo.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useGlucoseCheck$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/hooks/useGlucoseCheck.tsx [app-client] (ecmascript)");
...
const GlucoseCheckDemo = ()=>{
    ...
    const [glucoseValue, setGlucoseValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlucoseCheckDemo.useEffect": ()=>{
            setMounted(true);
        }
    }["GlucoseCheckDemo.useEffect"], []);
    ...
    const ethersReadonlyProvider = publicClient ? new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].BrowserProvider(publicClient.transport) : undefined;
    const sameChainRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        "GlucoseCheckDemo.useRef[sameChainRef]": (currentChainId)=>currentChainId === chainId
    }["GlucoseCheckDemo.useRef[sameChainRef]"]);
    const sameSignerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        "GlucoseCheckDemo.useRef[sameSignerRef]": (currentSigner)=>{
    ...
    }["GlucoseCheckDemo.useRef[sameSignerRef]"]);
    // Update refs when chainId or ethersSigner changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlucoseCheckDemo.useEffect": ()=>{
            sameChainRef.current = ({
                "GlucoseCheckDemo.useEffect": (currentChainId)=>currentChainId === chainId
            })["GlucoseCheckDemo.useEffect"];
        }
    }["GlucoseCheckDemo.useEffect"], [
        chainId
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlucoseCheckDemo.useEffect": ()=>{
            sameSignerRef.current = ({
                "GlucoseCheckDemo.useEffect": (currentSigner)=>{
                    if (!currentSigner || !ethersSigner) return false;
                    const currentAddress = currentSigner.address;
                    const ethersSignerAddress = ethersSigner.address;
                    if (!currentAddress || !ethersSignerAddress) return false;
    ...
    const provider = publicClient === null || publicClient === void 0 ? void 0 : publicClient.transport;
    ...
    const glucoseCheck = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useGlucoseCheck$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGlucoseCheck"])({
    ...
    const buttonClass = "inline-flex items-center justify-center rounded-xl bg-purple-600 px-6 py-3 font-semibold text-white shadow-sm " + "transition-colors duration-200 hover:bg-purple-700 active:bg-purple-800 " + "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2 " + "disabled:opacity-50 disabled:pointer-events-none";
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            fileName: "[project]/frontend/components/GlucoseCheckDemo.tsx",
                            lineNumber: 120,
                            columnNumber: 13
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Please connect your Rainbow wallet to use the Encrypted Glucose Check system"
                    }, void 0, false, {
                        fileName: "[project]/frontend/components/GlucoseCheckDemo.tsx",
                        lineNumber: 135,
                        columnNumber: 11
    ...
    const hasGlucose = glucoseCheck.glucoseHandle && glucoseCheck.glucoseHandle !== __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroHash;
    const hasRiskResult = glucoseCheck.riskResultHandle && glucoseCheck.riskResultHandle !== __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroHash;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "col-span-full bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        className: "text-2xl font-bold text-white mb-4",
                        children: "Submit Glucose Value"
                    }, void 0, false, {
                        fileName: "[project]/frontend/components/GlucoseCheckDemo.tsx",
                        lineNumber: 160,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: glucoseCheck.isSubmitting ? "Submitting..." : "Submit"
                            }, void 0, false, {
                                fileName: "[project]/frontend/components/GlucoseCheckDemo.tsx",
                                lineNumber: 170,
                                columnNumber: 11
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            "Check if your glucose level is high (glucose ",
                            '>',
                            " 140 mg/dL)"
                        ]
                    }, void 0, true, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: glucoseCheck.isChecking ? "Checking..." : "Check Risk"
                    }, void 0, false, {
                        fileName: "[project]/frontend/components/GlucoseCheckDemo.tsx",
                        lineNumber: 185,
                        columnNumber: 9
            ...
            hasRiskResult && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "col-span-full bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        className: "text-2xl font-bold text-white mb-4",
                        children: "Risk Result"
                    }, void 0, false, {
                        fileName: "[project]/frontend/components/GlucoseCheckDemo.tsx",
                        lineNumber: 196,
                        columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-white/80 mb-4",
                        children: "Your encrypted risk assessment result is available. Decrypt to view the result."
                    }, void 0, false, {
                        fileName: "[project]/frontend/components/GlucoseCheckDemo.tsx",
                        lineNumber: 197,
                        columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: glucoseCheck.isDecrypting ? "Decrypting..." : glucoseCheck.isDecrypted ? "Decrypted: ".concat(glucoseCheck.clearRiskResult ? "High" : "Normal") : "Decrypt Result"
                    }, void 0, false, {
                        fileName: "[project]/frontend/components/GlucoseCheckDemo.tsx",
                        lineNumber: 200,
                        columnNumber: 11
                    }, ("TURBOPACK compile-time value", void 0)),
                    glucoseCheck.isDecrypted && glucoseCheck.clearRiskResult !== undefined && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-4 p-4 bg-white/20 rounded-lg",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-white font-semibold",
                            children: [
                                "Result: ",
                                glucoseCheck.clearRiskResult ? "⚠️ High glucose (>140 mg/dL)" : "✅ Normal glucose (≤140 mg/dL)"
                            ]
                        }, void 0, true, {
                            fileName: "[project]/frontend/components/GlucoseCheckDemo.tsx",
                            lineNumber: 213,
...
_s(GlucoseCheckDemo, "RpYFTFn94NQ4SvIk8G/+DiG9cTk=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$hooks$2f$useGlucoseCheck$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGlucoseCheck"]
    ];
});
_c = GlucoseCheckDemo;
var _c;
__turbopack_context__.k.register(_c, "GlucoseCheckDemo");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=frontend_e723b8f8._.js.map